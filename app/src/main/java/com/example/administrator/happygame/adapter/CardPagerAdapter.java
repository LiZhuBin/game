...
public class CardPagerAdapter extends PagerAdapter implements com.example.administrator.happygame.adapter.CardAdapter {
    ...
    private void setClickGoOtherItem(int setPosition) {
        if (setPosition != CurItem && FatherViewPager != null) //要在FatherViewPager有的情况下
        {
            ...
            Toast.makeText(mContext, "This" + setPosition, Toast.LENGTH_SHORT).show();
        }
