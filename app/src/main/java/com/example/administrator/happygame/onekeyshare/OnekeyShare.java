...
package com.example.administrator.happygame.onekeyshare;
...
public class OnekeyShare {
    ...
    public OnekeyShare() {
        ...
        params.put("customers", new ArrayList<com.example.administrator.happygame.onekeyshare.CustomerLogo>());
    ...
    public void setCustomerLogo(Bitmap logo, String label, OnClickListener ocl) {
        com.example.administrator.happygame.onekeyshare.CustomerLogo cl = new com.example.administrator.happygame.onekeyshare.CustomerLogo();
        cl.logo = logo;
        cl.label = label;
        cl.listener = ocl;
        ArrayList<com.example.administrator.happygame.onekeyshare.CustomerLogo> customers = ResHelper.forceCast(params.get("customers"));
        customers.add(cl);
    }
    ...
    public void show(Context context) {
        ...
        themeImpl.setCustomerLogos((ArrayList<com.example.administrator.happygame.onekeyshare.CustomerLogo>) shareParamsMap.remove("customers"));
