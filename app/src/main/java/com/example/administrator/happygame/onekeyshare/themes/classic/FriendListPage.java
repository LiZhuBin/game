...
package com.example.administrator.happygame.onekeyshare.themes.classic;
...
import com.example.administrator.happygame.onekeyshare.OnekeySharePage;
import com.example.administrator.happygame.onekeyshare.OnekeyShareThemeImpl;
...
public abstract class FriendListPage extends OnekeySharePage implements OnClickListener, OnItemClickListener {
    ...
    private com.example.administrator.happygame.onekeyshare.themes.classic.FriendAdapter adapter;
    ...
    public void onCreate() {
        ...
        adapter = new com.example.administrator.happygame.onekeyshare.themes.classic.FriendAdapter(this, followList);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if ("FacebookMessenger".equals(platform.getName())) {
            if (lastPosition >= 0) {
                com.example.administrator.happygame.onekeyshare.themes.classic.FriendAdapter.Following lastFollwing = adapter.getItem(lastPosition);
                lastFollwing.checked = false;
            }
            lastPosition = position;
        }
        com.example.administrator.happygame.onekeyshare.themes.classic.FriendAdapter.Following following = adapter.getItem(position);
