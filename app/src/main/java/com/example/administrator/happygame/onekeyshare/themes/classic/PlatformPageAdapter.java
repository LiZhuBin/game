...
import com.example.administrator.happygame.onekeyshare.CustomerLogo;
...
public abstract class PlatformPageAdapter extends ViewPagerAdapter implements OnClickListener {
    ...
    private com.example.administrator.happygame.onekeyshare.themes.classic.PlatformPage page;
    private com.example.administrator.happygame.onekeyshare.themes.classic.IndicatorView vInd;
    private long lastClickTime;

    public PlatformPageAdapter(com.example.administrator.happygame.onekeyshare.themes.classic.PlatformPage page, ArrayList<Object> cells) {
        this.page = page;
    ...
    public void setIndicator(com.example.administrator.happygame.onekeyshare.themes.classic.IndicatorView view) {
        vInd = view;
    }
