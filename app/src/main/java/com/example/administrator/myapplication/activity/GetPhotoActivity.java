...
import com.example.administrator.myapplication.thing_class.lookphotoitemdecorate;
...
public class GetPhotoActivity extends BaseActivity {
    ...
    private void initFolderOverflowRecyclerview() {
        ...
        GridLayoutManager myLinearlayoutManger1 = new GridLayoutManager(this,1);recyclerView1.setLayoutManager(myLinearlayoutManger1);
