...
public class LeftFragmentBehavior extends CoordinatorLayout.Behavior<View> {
    public LeftFragmentBehavior() {

    }

    public LeftFragmentBehavior(Context context, AttributeSet attrs) {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
        ...
        ViewCompat.setTranslationX(child,-top);
        return false;
    }
}
